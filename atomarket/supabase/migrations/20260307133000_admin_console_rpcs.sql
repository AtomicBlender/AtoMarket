...
grant execute on function public.admin_get_markets(text, text, text, text, integer, integer) to authenticated;
...
grant execute on function public.admin_get_users(text, text, text, text, integer, integer) to authenticated;
